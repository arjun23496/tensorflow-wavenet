...
entropy_folder_path = "/home/arjun/chaos/work/corpus/entropy_files/"
for folder_path in list_dirs(entropy_folder_path):
	...
	for rand_idx in rand_indices:
		...
		if isfile(file_path):
			shutil.move(file_path,"/home/arjun/chaos/work/tensorflow-wavenet/test-corpus/" + file_path.split("/")[-1])
